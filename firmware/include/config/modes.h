 ...
 * Animation
 */
#if !defined(MODE_ANIMATION) && (EXTENSION_MQTT || EXTENSION_RESTFUL || EXTENSION_WEBSOCKET)
 ...
 * Draw
 */
#if !defined(MODE_DRAW) && (EXTENSION_MQTT || EXTENSION_RESTFUL || EXTENSION_WEBSOCKET)
 ...
 * Flies
 */
#if !defined(MODE_FLIES) && (EXTENSION_MQTT || EXTENSION_RESTFUL || EXTENSION_WEBSOCKET)
...
#if !defined(MODE_HOMETHERMOMETER) && (EXTENSION_MQTT || EXTENSION_RESTFUL || EXTENSION_WEBSOCKET)
