...
private:
    ...
    std::vector<std::pair<const char *, const char *>> parts{
        ...
        {"/data/2.5/weather", "lat=" LATITUDE "&lon=" LONGITUDE "&appid=" OPENWEATHER_KEY},
#if TEMPERATURE_KELVIN
        {"/data/3.0/onecall",
         "lat=" LATITUDE "&lon=" LONGITUDE
         "&exclude=alerts,daily,hourly,minutely&units=standard&appid=" OPENWEATHER_KEY},
        {"/data/2.5/weather", "lat=" LATITUDE "&lon=" LONGITUDE "&units=standard&appid=" OPENWEATHER_KEY},
#elif TEMPERATURE_CELSIUS
        {"/data/3.0/onecall",
         "lat=" LATITUDE "&lon=" LONGITUDE "&exclude=alerts,daily,hourly,minutely&units=metric&appid=" OPENWEATHER_KEY},
        {"/data/2.5/weather", "lat=" LATITUDE "&lon=" LONGITUDE "&units=metric&appid=" OPENWEATHER_KEY},
#elif TEMPERATURE_FAHRENHEIT
        {"/data/3.0/onecall",
         "lat=" LATITUDE "&lon=" LONGITUDE
         "&exclude=alerts,daily,hourly,minutely&units=imperial&appid=" OPENWEATHER_KEY},
        {"/data/2.5/weather", "lat=" LATITUDE "&lon=" LONGITUDE "&units=imperial&appid=" OPENWEATHER_KEY},
