...
static constexpr std::string_view default_entity_id{"def_ent_id"};
...
static constexpr std::string_view group{"grp"};
...
static constexpr std::string_view timezone{"tz"};
...
static constexpr std::string_view sw_version{HomeAssistantDeviceAbbreviations::sw_version};
}; // namespace HomeAssistantOriginAbbreviations
