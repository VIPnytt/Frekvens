...
Most common LDRs work well when paired with a reasonably sized resistor. A good starting point is a CdS photoresistor (e.g. [this](https://www.adafruit.com/product/161)) paired with a 10 kΩ through-hole resistor (e.g. [this](https://www.adafruit.com/product/2784)). For a clean installation, the LDR can be placed inside a standard LED cap (e.g. [this](https://www.toby.co.uk/led-and-light-pipes/led-mounts-and-spacers/lc3-and-lc5-valcon-3mm-and-5mm-led-lens-caps/)).
